	 ...
	 <?php  foreach ($approve_detail as $all_approve){ ?>
	  ...
	  <br/><br/><br/>
		...
		<?php echo "Approver Signature :" ;?></b></br></br><!-- Display Approver signature-->
			...
			<?php echo form_open('indent_approve/indent_approval',array('class'=>'form-group','role'=>'form'));?> <!-- Indent Approval print form open-->
		   <div class ="col-md-8 col-md-offset-3"> <div class="alert alert-info"><center> <strong><?php if(isset($msg)){ echo $msg;} ?></strong> </center></div></div>
			...
			<?php echo form_open('indent_approve/indent_approval',array('class'=>'form-custom','role'=>'form'))?><!-- Indent Approval form open-->
								...
								<div class="col-md-11">
									<center><h3>List Of Orders For Approval</h3></center>           
										...
										<tbody>
											...
											<tr>
												<td><?php  echo $i++; ?> 
													<?php echo form_open('indent_approve/indent_approval',array('class'=>'form-custom','id'=>'select_'.$indent->indent_id,'role'=>'form'))?><!-- Indent Approval form open-->
