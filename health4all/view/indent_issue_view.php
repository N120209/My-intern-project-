...
<?php echo form_open('indent_issue/indent_issued',array('class'=>'form-group','role'=>'form'));?> <!-- Issue Print Form opened-->
<div class ="col-md-8 col-md-offset-3"> <div class="alert alert-info"><center> <strong><?php if(isset($msg)){ echo $msg;} ?></strong> </center></div></div>
	...
	<?php 
			...
			<?php echo form_open('indent_issue/indent_issued',array('class'=>'form-custom','role'=>'form'))?><!-- Indent Issue form open-->
								...
								<div class="col-md-11">
									<center><h3>List Of Orders For Issue</h3></center>           
										...
										<tbody>
											...
											<tr>
												<td><?php  echo $i++; ?> 
													<?php echo form_open('indent_issue/indent_issued',array('class'=>'form-custom','id'=>'select_'.$indent->indent_id,'role'=>'form'))?><!-- Indent Issue form open-->
